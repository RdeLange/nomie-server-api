 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2a$08$46EC2EGwHGuLDc6E7T7xC.OiIz/M9vLO0iQyNJkXzodSQiUuD2lo6",
            permissions: "*"
        }]
    },
 ...
 ******************************************************************************/
     ...
     */
     ...
     //     res.sendFile(path.resolve(path.join('/root/.node-red/icons', req.url)))
     //   } else {
     //     next()
     //   }
     //}
